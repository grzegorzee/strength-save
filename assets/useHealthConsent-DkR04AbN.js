import{_ as S}from"./firebase-CLdSoD3Y.js";import{aR as j,w as y,E as u,y as s,e as z}from"./index-Z8WkHsBD.js";import{bb as b,o as R,aL as D}from"./AuthenticatedApp-DFulwmWM.js";import{e as t}from"./haptics-DUQggeAw.js";const w={width:1080,height:1920};async function T(e){const i=(r,o,c)=>{const v=Math.min(1,w.width/r,w.height/o),a=document.createElement("canvas");a.width=Math.max(1,Math.round(r*v)),a.height=Math.max(1,Math.round(o*v));const x=a.getContext("2d");if(!x)throw new Error("canvas-2d-unavailable");return x.drawImage(c,0,0,a.width,a.height),a.toDataURL("image/jpeg",.8)};if(typeof createImageBitmap=="function"){const r=await createImageBitmap(e,{imageOrientation:"from-image"});try{return i(r.width,r.height,r)}finally{r.close()}}const n=URL.createObjectURL(e);try{const r=new Image;return r.src=n,await r.decode(),i(r.naturalWidth,r.naturalHeight,r)}finally{URL.revokeObjectURL(n)}}function $(e){return`
  ...
  `}async function B(e,i,n="pl",r="kg",o="gradient",c="tonnage"){const{default:v}=await S(async()=>{const{default:g}=await import("./html2canvas-pro.esm-81Q1TmhQ.js");return{default:g}},[]),a=document.createElement("div");a.style.cssText="position:fixed;left:-9999px;top:0;width:540px;height:960px;";const x=o==="photo"&&i;a.innerHTML=x?E(e,i,n,r):o==="story"?P(e,n,r,c,j().hex):L(e,n,r,o==="minimal"?"minimal":"gradient"),document.body.appendChild(a);try{const g=await v(a.firstElementChild,{scale:2,useCORS:!0,backgroundColor:"#0f172a"});return new Promise((h,p)=>{g.toBlob(d=>d?h(d):p(new Error("Failed to create blob")),"image/jpeg",.85)})}finally{document.body.removeChild(a)}}const H=()=>{var i;const{profile:e}=R();return((i=D(e))==null?void 0:i.healthGranted)!==!1};export{T as d,B as g,H as u};
