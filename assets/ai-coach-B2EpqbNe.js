import{k as m}from"./firebase-CXN9cpOF.js";import{Z as c}from"./index-BuUslgXl.js";async function p(e){return(await m(c,"proxyOpenAI")({messages:e})).data.text||"[]"}const l=`Jesteś trenerem siłowym. Użytkownik nie może wykonać danego ćwiczenia i prosi o zamiennik.
