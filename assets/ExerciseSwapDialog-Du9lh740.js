import{c as f}from"./ai-coach-D71knZo2.js";import{e as N,c as x}from"./exerciseLibrary-BvJJs6wF.js";import{j as n,g as h,h as D}from"./index-EQ5S9gQf.js";import{D as O,a as E,b as P,c as A}from"./dialog-BvXCshXk.js";import{B as $}from"./badge-VE8WFzSr.js";import{P as I}from"./play-ByMMWIpa.js";const z={2:[{name:"Poniedziałek",weekday:"monday"},{name:"Czwartek",weekday:"thursday"}],3:[{name:"Poniedziałek",weekday:"monday"},{name:"Środa",weekday:"wednesday"},{name:"Piątek",weekday:"friday"}],4:[{name:"Poniedziałek",weekday:"monday"},{name:"Wtorek",weekday:"tuesday"},{name:"Czwartek",weekday:"thursday"},{name:"Piątek",weekday:"friday"}],5:[{name:"Poniedziałek",weekday:"monday"},{name:"Wtorek",weekday:"tuesday"},{name:"Środa",weekday:"wednesday"},{name:"Czwartek",weekday:"thursday"},{name:"Piątek",weekday:"friday"}]};async function J(a){const r=N.map(i=>`- ${i.name} (${i.category}, ${i.type})`).join(`
