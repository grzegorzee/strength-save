import{c as L,a$ as M,F as $,w as E,z as R}from"./index-D-lHLLX5.js";import{_ as C}from"./firebase-698yT-X-.js";import{cj as z,be as T,bB as _,ck as D,bC as W}from"./AuthenticatedApp-BLP75mJn.js";import{r as c}from"./react-vendor-DuJroiHx.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=L("CalendarRange",[["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M16 2v4",key:"4m81vk"}],["path",{d:"M3 10h18",key:"8toen8"}],["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M17 14h-6",key:"bkmgh3"}],["path",{d:"M13 18H7",key:"bb0bb7"}],["path",{d:"M7 14h.01",key:"1qa3f1"}],["path",{d:"M17 18h.01",key:"1bdyru"}]]),N=(e,a)=>{const o=z(e,12,a),i=o.reduce((s,t)=>({workoutCount:s.workoutCount+t.workoutCount,workoutsWithDuration:s.workoutsWithDuration+t.workoutsWithDuration,totalDurationSec:s.totalDurationSec+t.totalDurationSec,totalTonnageKg:s.totalTonnageKg+t.totalTonnageKg}),{workoutCount:0,workoutsWithDuration:0,totalDurationSec:0,totalTonnageKg:0});return{monthly:o,totals:i}},d=e=>e.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a]),O=(e,a)=>{const o=E(`${e}-01`).toLocaleDateString($(a),{month:"long",year:"numeric"});return o.charAt(0).toUpperCase()+o.slice(1)},A=(e,a,o,i,s)=>{const t=(n,r)=>R(a,n,r),p=e.monthly.map(n=>{const r=n.workoutCount-n.workoutsWithDuration;return`
      <tr>
  ...
  <div style="width:794px;background:#ffffff;color:#111111;font-family:'Inter',-apple-system,sans-serif;padding:48px;box-sizing:border-box;">
    <div style="border-left:6px solid ${M().hex};padding-left:16px;margin-bottom:8px;">
      <div style="font-size:26px;font-weight:700;text-transform:uppercase;letter-spacing:0.04em;">${d(t("report.title"))}</div>
      <div style="font-size:12px;color:#555;">Strength Save · ${d(i)} · ${d(s.toLocaleDateString($(a)))}</div>
    </div>
