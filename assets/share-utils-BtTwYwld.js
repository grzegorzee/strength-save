import{_ as S}from"./firebase-DdLkZA3K.js";import{aX as j,w as y,F as u,z as s,e as z}from"./index-CvMS48Bd.js";import{bM as b}from"./AuthenticatedApp-Dh1hXC9W.js";import{e as t}from"./haptics-DkgGI0B-.js";const w={width:1080,height:1920};async function I(e){const i=(r,o,c)=>{const v=Math.min(1,w.width/r,w.height/o),a=document.createElement("canvas");a.width=Math.max(1,Math.round(r*v)),a.height=Math.max(1,Math.round(o*v));const x=a.getContext("2d");if(!x)throw new Error("canvas-2d-unavailable");return x.drawImage(c,0,0,a.width,a.height),a.toDataURL("image/jpeg",.8)};if(typeof createImageBitmap=="function"){const r=await createImageBitmap(e,{imageOrientation:"from-image"});try{return i(r.width,r.height,r)}finally{r.close()}}const n=URL.createObjectURL(e);try{const r=new Image;return r.src=n,await r.decode(),i(r.naturalWidth,r.naturalHeight,r)}finally{URL.revokeObjectURL(n)}}function $(e){return`
  ...
  `}function L(e,i,n){const r=t(e.dayName),o=t(y(e.date).toLocaleDateString(u(i),{weekday:"long",day:"numeric",month:"long",year:"numeric"})),c=b(e.tonnage,n);return`
    <div style="
      width:540px;height:960px;
      background:#0b0b0f;
      color:#fff;font-family:system-ui,-apple-system,sans-serif;
  ...
  `}async function O(e,i,n="pl",r="kg",o="gradient",c="tonnage"){const{default:v}=await S(async()=>{const{default:g}=await import("./html2canvas-pro.esm-CeFCdQ9N.js");return{default:g}},[]),a=document.createElement("div");a.style.cssText="position:fixed;left:-9999px;top:0;width:540px;height:960px;";const x=o==="photo"&&i;a.innerHTML=x?P(e,i,n,r):o==="story"?M(e,n,r,c,j().hex):D(e,n,r,o==="minimal"?"minimal":"gradient"),document.body.appendChild(a);try{const g=await v(a.firstElementChild,{scale:2,useCORS:!0,backgroundColor:"#0f172a"});return new Promise((h,p)=>{g.toBlob(d=>d?h(d):p(new Error("Failed to create blob")),"image/jpeg",.85)})}finally{document.body.removeChild(a)}}export{I as d,O as g};
