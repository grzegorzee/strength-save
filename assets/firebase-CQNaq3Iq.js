 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mo(n,e){return[n,je(e)]}function pm(n,e,t){return[n,je(e),t]}const VE={},Lr="documentMutations",Vo="remoteDocumentsV14",OE=["prefixPath","collectionGroup","readTime","documentId"],go="documentKeyIndex",xE=["prefixPath","collectionGroup","documentId"],mm="collectionGroupIndex",LE=["collectionGroup","readTime","prefixPath","documentId"],oi="remoteDocumentGlobal",Yc="remoteDocumentGlobalKey",Mr="targets",gm="queryTargetsIndex",ME=["canonicalId","targetId"],Fr="targetDocuments",FE=["targetId","path"],Lu="documentTargetsIndex",UE=["path","targetId"],Oo="targetGlobalKey",jn="targetGlobal",ai="collectionParents",BE=["collectionId","parent"],Ur="clientMetadata",qE="clientId",ua="bundles",$E="bundleId",la="namedQueries",jE="name",Mu="indexConfiguration",GE="indexId",Xc="collectionGroupIndex",zE="collectionGroup",Gs="indexState",WE=["indexId","uid"],_m="sequenceNumberIndex",KE=["uid","sequenceNumber"],zs="indexEntries",HE=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],ym="documentKeyIndex",QE=["indexId","uid","orderedDocumentKey"],ha="documentOverlays",JE=["userId","collectionPath","documentId"],Zc="collectionPathOverlayIndex",YE=["userId","collectionPath","largestBatchId"],Im="collectionGroupOverlayIndex",XE=["userId","collectionGroup","largestBatchId"],Fu="globals",ZE="name",wm=[ii,gt,Lr,xn,Mr,Ai,jn,Fr,Ur,oi,ai,ua,la],eT=[...wm,ha],Em=[ii,gt,Lr,Vo,Mr,Ai,jn,Fr,Ur,oi,ai,ua,la,ha],Tm=Em,Uu=[...Tm,Mu,Gs,zs],tT=Uu,vm=[...Uu,Fu],nT=vm;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iT{constructor(e,t,r,s,i,o,c,u,l,f,p){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=o,this.autoDetectLongPolling=c,this.longPollingOptions=u,this.useFetchStreams=l,this.isUsingEmulator=f,this.apiKey=p}}const xo="(default)";class Hn{constructor(e,t){this.projectId=e,this.database=t||xo}static empty(){return new Hn("","")}get isDefaultDatabase(){return this.database===xo}isEqual(e){return e instanceof Hn&&e.projectId===this.projectId&&e.database===this.database}}function oT(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new V(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Hn(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ga{constructor(){this._=void 0}}function bT(n,e,t){return n instanceof di?function(s,i){const o={fields:{[Sm]:{stringValue:bm},[Cm]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&da(i)&&(i=fa(i)),i&&(o.fields[Pm]=i),{mapValue:o}}(t,e):n instanceof jr?Xm(n,e):n instanceof Gr?Zm(n,e):function(s,i){const o=Ym(s,i),c=Gd(o)+Gd(s.Ae);return nu(o)&&nu(s.Ae)?Qm(c):zu(s.serializer,c)}(n,e)}function ST(n,e,t){return n instanceof jr?Xm(n,e):n instanceof Gr?Zm(n,e):t}function Ym(n,e){return n instanceof zr?function(r){return nu(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class di extends ga{}class jr extends ga{constructor(e){super(),this.elements=e}}function Xm(n,e){const t=eg(e);for(const r of n.elements)t.some(s=>St(s,r))||t.push(r);return{arrayValue:{values:t}}}class Gr extends ga{constructor(e){super(),this.elements=e}}function Zm(n,e){let t=eg(e);for(const r of n.elements)t=t.filter(s=>!St(s,r));return{arrayValue:{values:t}}}class zr extends ga{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Gd(n){return ue(n.integerValue||n.doubleValue)}function eg(n){return li(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rg(n,e,t){const r=n.store(gt),s=n.store(Lr),i=[],o=IDBKeyRange.only(t.batchId);let c=0;const u=r.ee({range:o},(f,p,g)=>(c++,g.delete()));i.push(u.next(()=>{U(c===1,47070,{batchId:t.batchId})}));const l=[];for(const f of t.mutations){const p=pm(e,f.key.path,t.batchId);i.push(s.delete(p)),l.push(f.key)}return A.waitFor(i).next(()=>l)}function qo(n){if(!n)return 0;let e;if(n.document)e=n.document;else if(n.unknownDocument)e=n.unknownDocument;else{if(!n.noDocument)throw M(14731);e=n.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ao=null;function gu(){return ao===null?ao=function(){return 268435456+Math.round(2147483648*Math.random())}():ao++,"0x"+ao.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sc="RestConnection",Vv={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class Ov{get Ko(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.qo=t+"://"+e.host,this.Uo=`projects/${r}/databases/${s}`,this.$o=this.databaseId.database===xo?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Wo(e,t,r,s,i){const o=gu(),c=this.Qo(e,t.toUriEncodedString());D(Sc,`Sending RPC '${e}' ${o}:`,c,r);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(u,s,i);const{host:l}=new URL(c),f=kt(l);return this.zo(e,c,u,r,f).then(p=>(D(Sc,`Received RPC '${e}' ${o}: `,p),p),p=>{throw ni(Sc,`RPC '${e}' ${o} failed with error: `,p,"url: ",c,"request:",r),p})}jo(e,t,r,s,i,o){return this.Wo(e,t,r,s,i)}Go(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+es}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,i)=>e[i]=s),r&&r.headers.forEach((s,i)=>e[i]=s)}Qo(e,t){const r=Vv[e];let s=`${this.qo}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ea(n){return new BT(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Di extends g_{constructor(e){super(),this.firestore=e}convertBytes(e){return new et(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new de(this.firestore,null,t)}}function x0(n){return new bl("increment",n)}const Uf="@firebase/firestore",Bf="4.10.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cR extends aR{constructor(e,t){super(e,t),this._firestore=e}get(e){const t=cn(e,this._firestore),r=new Di(this._firestore);return super.get(e).then(s=>new pn(this._firestore,r,t._key,s._document,new Rr(!1,!1),t.converter))}}function G0(n,e,t){n=Ve(n,ot);const r={...iR,...t};(function(o){if(o.maxAttempts<1)throw new V(S.INVALID_ARGUMENT,"Max attempts must be at least 1")})(r);const s=bn(n);return MA(s,i=>e(new cR(n,i)),r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z0(n){n=Ve(n,de);const e=Ve(n.firestore,ot),t=bn(e);return a_(t,n._key).then(r=>xl(e,n,r))}function W0(n){n=Ve(n,de);const e=Ve(n.firestore,ot),t=bn(e);return a_(t,n._key,{source:"server"}).then(r=>xl(e,n,r))}function K0(n){n=Ve(n,Nt);const e=Ve(n.firestore,ot),t=bn(e),r=new Di(e);return __(n._query),OA(t,n._query).then(s=>new Gn(e,r,n,s))}function H0(n,e,t){n=Ve(n,de);const r=Ve(n.firestore,ot),s=ka(n.converter,e,t),i=hr(r);return Vi(r,[ba(i,"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,he.none())])}function Q0(n,e,t,...r){n=Ve(n,de);const s=Ve(n.firestore,ot),i=hr(s);let o;return o=typeof(e=G(e))=="string"||e instanceof os?Pl(i,"updateDoc",n._key,e,t,r):Sl(i,"updateDoc",n._key,e),Vi(s,[o.toMutation(n._key,he.exists(!0))])}function J0(n){return Vi(Ve(n.firestore,ot),[new ns(n._key,he.none())])}function Y0(n,e){const t=Ve(n.firestore,ot),r=qA(n),s=ka(n.converter,e),i=hr(n.firestore);return Vi(t,[ba(i,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,he.exists(!1))]).then(()=>r)}function X0(n,...e){var l,f,p;n=G(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||qf(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(qf(e[r])){const g=e[r];e[r]=(l=g.next)==null?void 0:l.bind(g),e[r+1]=(f=g.error)==null?void 0:f.bind(g),e[r+2]=(p=g.complete)==null?void 0:p.bind(g)}let i,o,c;if(n instanceof de)o=Ve(n.firestore,ot),c=bi(n._key.path),i={next:g=>{e[r]&&e[r](xl(o,n,g))},error:e[r+1],complete:e[r+2]};else{const g=Ve(n,Nt);o=Ve(g.firestore,ot),c=g._query;const v=new Di(o);i={next:C=>{e[r]&&e[r](new Gn(o,v,g,C))},error:e[r+1],complete:e[r+2]},__(n._query)}const u=bn(o);return VA(u,c,s,i)}function Vi(n,e){const t=bn(n);return LA(t,e)}function xl(n,e,t){const r=t.docs.get(e._key),s=new Di(n);return new pn(n,s,e._key,r,new Rr(t.hasPendingWrites,t.fromCache),e.converter)}function Z0(n){return n=Ve(n,ot),bn(n),new oR(n,e=>Vi(n,e))}(function(e,t=!0){pE(cr),ft(new st("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),c=new ot(new _E(r.getProvider("auth-internal")),new wE(o,r.getProvider("app-check-internal")),oT(o,s),o);return i={useFetchStreams:t,...i},c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),$e(Uf,Bf,e),$e(Uf,Bf,"esm2020")})();var uR="firebase",lR="12.8.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
