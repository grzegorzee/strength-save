import{c as f}from"./ai-coach-B2EpqbNe.js";import{e as N,c as x}from"./exerciseLibrary-BsrhpWm9.js";import{j as n,g as h,h as D}from"./index-BuUslgXl.js";import{D as O,a as E,b as P,c as A}from"./dialog-B0FJ8JoT.js";import{B as $}from"./badge-VtMunAxc.js";import{P as I}from"./play-WGlsPpnE.js";const z={2:[{name:"Poniedziałek",weekday:"monday"},{name:"Czwartek",weekday:"thursday"}],3:[{name:"Poniedziałek",weekday:"monday"},{name:"Środa",weekday:"wednesday"},{name:"Piątek",weekday:"friday"}],4:[{name:"Poniedziałek",weekday:"monday"},{name:"Wtorek",weekday:"tuesday"},{name:"Czwartek",weekday:"thursday"},{name:"Piątek",weekday:"friday"}],5:[{name:"Poniedziałek",weekday:"monday"},{name:"Wtorek",weekday:"tuesday"},{name:"Środa",weekday:"wednesday"},{name:"Czwartek",weekday:"thursday"},{name:"Piątek",weekday:"friday"}]};async function J(a){const r=N.map(i=>`- ${i.name} (${i.category}, ${i.type})`).join(`
