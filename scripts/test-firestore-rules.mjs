...
await seedDoc('email_log/el1/content', 'body', { html: '<p>Trening</p>', truncated: false });
...
add('email_log content: read admina ALLOWED (T21a)', true, await ok(() => getDoc(doc(adminDb, 'email_log/el1/content', 'body'))));
add('email_log content: read usera DENIED (T21a)', false, await ok(() => getDoc(doc(db, 'email_log/el1/content', 'body'))));
add('email_log content: write admina DENIED (pisze tylko backend) (T21a)', false, await ok(() => setDoc(doc(adminDb, 'email_log/el1/content', 'body2'), { html: '<p>x</p>', truncated: false })));
